# Data Source Documentation: `portainer_edge_mtls_ca_certificate`

# portainer_edge_mtls_ca_certificate

> **Business Edition only.** This endpoint does not exist in Portainer CE.


Reads the parsed X.509 details of the CA certificate Portainer verifies edge agent certificates against.
...
output "edge_mtls_ca_certificate_expiry" {
