...
| Name | Type |
|------|------|
| [portainer_stack.swarm_repository](https://registry.terraform.io/providers/portainer/portainer/latest/docs/resources/stack) | resource |
...
| <a name="input_stack_name"></a> [stack\_name](#input\_stack\_name) | Name of the stack | `string` | `"nginx-swarm-repository"` | no |
