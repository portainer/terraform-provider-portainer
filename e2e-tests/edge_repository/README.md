...
| <a name="input_edge_stack_file_path_in_repository"></a> [edge\_stack\_file\_path\_in\_repository](#input\_edge\_stack\_file\_path\_in\_repository) | Inline file content for the template (YAML/Compose) | `string` | `"gitea-postgres/compose.yaml"` | no |
...
| <a name="input_edge_stack_repository_url"></a> [edge\_stack\_repository\_url](#input\_edge\_stack\_repository\_url) | Inline stack file content for the Edge Stack | `string` | `"https://github.com/docker/awesome-compose"` | no |
