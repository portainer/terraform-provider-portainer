...
| `portainer_endpoints_edge_generate_key`  | [endpoints_edge_generate_key.md](docs/resources/endpoints_edge_generate_key.md) | [example](examples/endpoints_edge_generate_key/) | ![Done](https://img.shields.io/badge/status-done-brightgreen) | ![Not yet](https://img.shields.io/badge/import-no-lightgrey)     | ![None](https://img.shields.io/badge/running-false-grey)  |
| `portainer_edge_configurations`          | [edge_configurations.md](docs/resources/edge_configurations.md) | [example](examples/edge_configurations/) | ![Done](https://img.shields.io/badge/status-done-brightgreen) | ![Not yet](https://img.shields.io/badge/import-no-lightgrey)     | ![None](https://img.shields.io/badge/running-false-grey)  |
| `portainer_edge_update_schedules`        | [edge_update_schedules.md](docs/resources/edge_update_schedules.md) | [example](examples/edge_update_schedules/) | ![Done](https://img.shields.io/badge/status-done-brightgreen) | ![Not yet](https://img.shields.io/badge/import-no-lightgrey)     | ![None](https://img.shields.io/badge/running-false-grey)  |
...
| `portainer_docker_plugin`    | [docker_plugin.md](docs/resources/docker_plugin.md)        | [example](examples/docker_plugin/)      | ![Done](https://img.shields.io/badge/status-done-brightgreen)     | ![Not yet](https://img.shields.io/badge/import-no-lightgrey)     | ![Daily](https://img.shields.io/badge/running-daily-blue) |
...
| `portainer_open_amt_activate`            | [open_amt_activate.md](docs/resources/open_amt_activate.md) | [example](examples/open_amt_activate/) | ![Done](https://img.shields.io/badge/status-done-brightgreen) | ![Not yet](https://img.shields.io/badge/import-no-lightgrey)     | ![None](https://img.shields.io/badge/running-false-grey)  |
...
| `portainer_settings_experimental`        | [settings_experimental.md](docs/resources/settings_experimental.md) | [example](examples/settings_experimental/) | ![Done](https://img.shields.io/badge/status-done-brightgreen) | ![Not yet](https://img.shields.io/badge/import-no-lightgrey)     | ![None](https://img.shields.io/badge/running-false-grey)  |
...
| `portainer_tls`              | [tls.md](docs/resources/tls.md)                            | [example](examples/tls/)                | ![Done](https://img.shields.io/badge/status-done-brightgreen)     | ![Not yet](https://img.shields.io/badge/import-no-lightgrey)     | ![None](https://img.shields.io/badge/running-false-grey)  |
...
| `portainer_edge_stack_webhook` | [edge_stack_webhook.md](docs/resources/edge_stack_webhook.md)        | [example](examples/edge_stack_webhook/)      | ![Done](https://img.shields.io/badge/status-done-brightgreen)     | ![Not yet](https://img.shields.io/badge/import-no-lightgrey)     | ![None](https://img.shields.io/badge/running-false-grey)  |
...
| `portainer_support_debug_log`                      | [support_debug_log.md](docs/resources/support_debug_log.md)                     | [example](examples/support_debug_log/)          | ![Done](https://img.shields.io/badge/status-done-brightgreen) | ![Not yet](https://img.shields.io/badge/import-no-lightgrey)     | ![None](https://img.shields.io/badge/running-false-grey)  |
| `portainer_sshkeygen`                    | [sshkeygen.md](docs/resources/sshkeygen.md)                 | [example](examples/sshkeygen/)        | ![Done](https://img.shields.io/badge/status-done-brightgreen) | ![Not yet](https://img.shields.io/badge/import-no-lightgrey)     | ![None](https://img.shields.io/badge/running-false-grey)  |
